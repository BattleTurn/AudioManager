...
namespace BattleTurn.AudioManagement.Editor
{
    ...
    {
        internal const string GENERATED_FOLDER_PATH = "Assets/Plugins/" + nameof(BattleTurn) + "/Generated/" + nameof(AudioManagement);
        internal const string GENERATED_SCRIPT_PATH = GENERATED_FOLDER_PATH + "/Scripts";
        internal const string GENERATED_SCRIPTABLE_OBJECT_PATH = GENERATED_FOLDER_PATH + "/ScriptableObjects";

        internal const string GENERATED_RUNTIME_NAMESPACE = nameof(BattleTurn) + "." + nameof(AudioManagement) + "." + nameof(Runtime);
